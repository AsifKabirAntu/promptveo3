...
export function VideoShowcase() {
  ...
  return (
    <section id="video-showcase" className="py-12 sm:py-16 lg:py-24 bg-gradient-to-br from-blue-50 to-purple-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="inline-flex items-center rounded-full bg-blue-100 px-3 py-1 text-sm font-medium text-blue-800 mb-6 sm:mb-8 gap-2">
          ...
          <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto px-4">
            Side‑by‑side outputs from the exact JSON you’ll use. Fast for speed, Quality for polish.
          </p>
        </div>
