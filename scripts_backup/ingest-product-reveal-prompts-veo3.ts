...
// Function to ingest product reveal prompts for veo3 from JSON
async function ingestProductRevealPromptsVeo3() {
  try {
    const filePath = path.join(process.cwd(), 'data', 'product_reveal_prompts_for_veo3.json')
...
async function main() {
  ...
  await ingestProductRevealPromptsVeo3()
}
