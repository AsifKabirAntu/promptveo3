...
async function ingestBrandedRoomTransformationPrompts() {
  try {
    const filePath = 'data/branded_real_room_transformation_1-8.json'
    ...
    console.log(`\n🎉 Branded room transformation data ingestion complete!`)
...
// Run the script
ingestBrandedRoomTransformationPrompts().catch(console.error) 